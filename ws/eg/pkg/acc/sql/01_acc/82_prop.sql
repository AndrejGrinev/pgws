...
INSERT INTO cfg.prop (code, pkg, pogc_list, def_value, name, has_log) VALUES
  ('isv.password_attempt_count',    :AG, ARRAY[:TG], '3',  'кол-во попыток ввода пароля',              FALSE)
, ('isv.password_attempt_interval', :AG, ARRAY[:TG], '8',  'интервал попыток ввода пароля(в минутах)', FALSE)
, ('isv.password_lock_interval',    :AG, ARRAY[:TG], '10', 'интервал блокировки(в минутах)',           FALSE)
;
